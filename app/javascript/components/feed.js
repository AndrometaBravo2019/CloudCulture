      ...
      <Container className = "feed">
         ...
         {closePosts.map((post,index) => {
            if(statusFilterArr.includes(post.post_status)){
              ...
              return(
                ...
                <a align="left" href={`userprofile/${post.user.id}`}>
                  <img className="feed-avatar" id="postfeed" src ={post.user.picture_url} alt=''/>
                </a>
                ...
                <div className = 'row'>
                  ...
                  <div className = 'col-4'>
                    <p align="left">posted:
                      <font color = 'orange'>{post.created_at}</font>
                    </p>
                  </div>
                  ...
                  <div className = 'col-4'>
                    <p align="center">project:
                      <font color = 'orange'>
                        {post.tags.length > 0 && post.tags[0].tagname.tag || "no tags" }
                      </font>
                    </p>
                  </div>
        ...
        <p align="center">
          <a className="nav-link active" href="">
            <font color = 'orange'>NEW POST</font>
          </a>
        </p>
      </Container>
    )
